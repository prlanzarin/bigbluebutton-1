...
String welcome = "<br>Welcome to <b>%%CONFNAME%%</b>!<br><br>In order to call to the conference using a SIP endpoint, use the URI sip:%%CONFNUM%%@mconf-demo-sip-magic.redclara.net";
