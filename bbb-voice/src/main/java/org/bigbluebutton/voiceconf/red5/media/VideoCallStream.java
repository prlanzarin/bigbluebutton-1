...
public class VideoCallStream implements StreamObserver {
    private final static Logger log = Red5LoggerFactory.getLogger(VideoCallStream.class, "sip");
    ...
    public VideoCallStream(Codec sipCodec, SipConnectInfo connInfo, IScope scope) {        
