...
object MessageNames {
  ...
  val VOICE_OUTBOUND_DIAL = "voice_outbound_dial_message"
  val VOICE_CANCEL_DIAL = "voice_cancel_dial_message"
  val VOICE_CLEAR_DIAL = "voice_clear_dial_message"
  val VOICE_DIALING = "voice_dialing_message"
  val VOICE_HANGING_UP = "voice_hanging_up_message"
  ...
  val SIP_PHONE_UPDATE = "sip_phone_update"
