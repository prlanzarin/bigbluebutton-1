...
public class AudioCallStream implements StreamObserver {
    private final static Logger log = Red5LoggerFactory.getLogger(AudioCallStream.class, "sip");
    ...
    public AudioCallStream(Codec sipCodec, SipConnectInfo connInfo, IScope scope) {        
